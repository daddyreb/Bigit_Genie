#ifndef QGENIEPLUGIN_BASIC_REMOTE_PRINTING_READYSHARE_H
#define QGENIEPLUGIN_BASIC_REMOTE_PRINTING_READYSHARE_H
...
class QGeniePlugin_Basic_Remote_Printing_ReadyShare : public QWidget
{
    Q_OBJECT
public:
    explicit QGeniePlugin_Basic_Remote_Printing_ReadyShare(QWidget *parent = 0);
...
public slots:
    ...
    void rdobasicchecked();
    void rdoremotechecked();
    void rdoprintingchecked();
