...
bool SsdpSearchTask::report(const NPT_DataBuffer& data, const NPT_SocketAddress& fromAddr)
{
	if (m_callback) {
		return m_callback->ssdpSearchTaskOnPacket(this, data, fromAddr);
	}
	return false;
}
