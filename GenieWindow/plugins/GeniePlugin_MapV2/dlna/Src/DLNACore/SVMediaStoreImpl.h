#ifndef __SV_MEDIASTOREIMPL_H__
#define __SV_MEDIASTOREIMPL_H__

#include "SVMediaStore.h"
#include "SVTaskGroup.h"
#include "SVUtils.h"
...
public:
	...
	void importFileSystem(const NPT_List<NPT_String>& dirs, const NPT_List<NPT_String>& names, bool ignoreDot, ShareType eType);
	...
	void getImportResult(NPT_List<MSImportResult>& ls);
...
private:
	...
	NPT_List<MSImportResult> m_MSResultList;
...
public:
	...
	MSImportTask(MediaStoreImpl *owner, const NPT_List<NPT_String>& dirs, const NPT_List<NPT_String>& names, bool ignoreDot, ShareType eType);
...
private:
	void import(ImportContext *impCtx, MSFolder *parentFolder, const NPT_String& dir, const NPT_FileInfo& dirInfo, ShareType eType);
	void importFile(ImportContext *impCtx, MSFolder *parentFolder, const NPT_String& path, const NPT_FileInfo& fileInfo, const NPT_String& dir, ShareType eType);
