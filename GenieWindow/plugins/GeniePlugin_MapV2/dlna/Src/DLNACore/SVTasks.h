#ifndef __SV_TASKS_H__
#define __SV_TASKS_H__
...
public:
	...
	public:
		virtual ~Callback();
		virtual bool ssdpSearchTaskOnPacket(SsdpSearchTask *task, const NPT_DataBuffer& packet, const NPT_SocketAddress& fromAddr) = 0;
...
private:
	...
	bool report(const NPT_DataBuffer& data, const NPT_SocketAddress& fromAddr);
