...
void MediaStore::importFileSystem(const NPT_List<NPT_String>& dirs, const NPT_List<NPT_String>& names, bool ignoreDot, ShareType eType)
{
	m_impl->importFileSystem(dirs, names, ignoreDot, eType);
}
