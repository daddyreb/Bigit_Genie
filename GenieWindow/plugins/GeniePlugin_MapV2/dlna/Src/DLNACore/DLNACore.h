...
{
public:
	virtual void onDiscoveryListChaned(const NPT_String& ip, const NPT_String& devName, const int type) = 0;
...
public:
	...
	void importFileSystemToMediaServer(const NPT_List<NPT_String>& dirs, const NPT_List<NPT_String>& names, bool ignoreDot = false, ShareType eType = ShareType_VAI);
