#ifndef MYQPROGRESSINDICATOR_H
#define MYQPROGRESSINDICATOR_H
...
/*! 
    ...
    \sa QProgressBar
*/
class MyProgressIndicator : public QWidget
{
    Q_OBJECT
...
public:
    MyProgressIndicator(QWidget* parent = 0);
