...
public:
	bool parser_get_enable(QString& xml, bool& enable, QString& status_name, QString& waittime, QString& error);
	...
	bool parser_del_white_url(QString& xml, QString& error);
	bool parser_get_white_url_page(QString& xml, QStringList& white_url, QString& error);
};
