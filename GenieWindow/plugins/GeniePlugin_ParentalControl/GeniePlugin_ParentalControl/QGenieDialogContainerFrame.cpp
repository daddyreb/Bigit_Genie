...
void QGenieDialogContainerFrame::init_dim(Dlg_Size_Model size_model)
{
    ...
    case Medium:
        ...
        m_framecontainer_style = QString::fromUtf8("#frame_container{background-image: url(:/img/MediumDlgBkg.png);color:rgb(0,0,0);font-size:12px;}");
        break;
    case Normal:
        m_dlg_width                             =  383;
        m_dlg_height                            = 212;
        ...
        m_framecontainer_style = QString::fromUtf8("#frame_container{background-image: url(:/img/NormalDlgBkg.png);color:rgb(0,0,0);font-size:12px;}");
        break;
    case Small:
        m_dlg_width                     =  228;
        m_dlg_height                    = 117;
        ...
        m_frame_tb_margin               = 11;
        m_framecontainer_style = QString::fromUtf8("#frame_container{background-image: url(:/img/SmallDlgBkg.png);color:rgb(0,0,0);font-size:12px;}");
        break;
    case Large:
    default:
        m_dlg_width                             =  538;
        ...
        m_framecontainer_style = QString::fromUtf8("#frame_container{background-image: url(:/img/BigDlgBkg.png);color:rgb(0,0,0);font-size:12px;}");
    }
