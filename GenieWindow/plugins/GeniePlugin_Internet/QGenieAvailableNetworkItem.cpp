...
QGenieAvailableNetworkItem::QGenieAvailableNetworkItem(QWidget *parent)
    : QFrame(parent),security_enabled(false),signal_strength(0)
{
...
//#endif
    ...
    sec_signal_layout->setSpacing(1);
...
void QGenieAvailableNetworkItem::retranslateUi()
{
    ...
    channel_text_lb->setText(/*tr("Channel: %1")*/
            GeniePlugin_Internet::translateText(L_INTERNET_CHANNEL_LB_TEXT).arg(channel));
    if(this->security_enabled)
    {
        ...
        securityprompt_text_lb->setText(/*tr(texts_to_tr[0])*/
                GeniePlugin_Internet::translateText(L_INTERNET_SECPROMPT_LB_Y_TEXT)
    ...
    else
    {
        securityprompt_text_lb->setText(/*tr(texts_to_tr[1])*/
                GeniePlugin_Internet::translateText(L_INTERNET_SECPROMPT_LB_N_TEXT ));
