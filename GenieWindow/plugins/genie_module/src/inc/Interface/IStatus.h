...
public:
	 ...
	 * @see #isMultiStatus()
	 */
	 virtual QVector<IStatus*> getChildren()=0;
	 ...
	 */
	 virtual /*Throwable*/void* getException()=0;
	 ...
	 * @see #INFO
	 */
	 virtual bool matches(int severityMask)=0;
};
#endif