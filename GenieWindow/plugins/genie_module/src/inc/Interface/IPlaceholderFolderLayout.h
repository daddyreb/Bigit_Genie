#ifndef IPLACEHOLDERFOLDERLAYOUT_H
#define IPLACEHOLDERFOLDERLAYOUT_H
...
class IPlaceholderFolderLayout {
     ...
     */
public:
	virtual void addPlaceholder(QString viewId)=0;
	 ...
	 * @since 3.3
	 */
     virtual QString getProperty(QString id)=0;
	 ...
	 * @since 3.3
	 */
     virtual void setProperty(QString id, QString value)=0;
};
#endif