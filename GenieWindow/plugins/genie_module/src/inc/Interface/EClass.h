...
class EClass {
   ...
   * @generated
   */
  void setInterface(bool value) = 0;
   ...
   * @generated
   */
  QList<EClass*> getEAllSuperTypes() = 0;
   ...
   * @generated
   */
  QList<EClass*> getEStructuralFeatures() = 0;
   ...
   * @generated
   */
  bool isSuperTypeOf(EClass* someClass) = 0;
